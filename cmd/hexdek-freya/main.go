// hexdek-freya -- Automatic combo and synergy detector for MTG decklists.
//
...
// Usage:
//
//	go run ./cmd/hexdek-freya/ --deck data/decks/benched/ragost_artifact_engine_b4_deft_gastronaut.txt
//	go run ./cmd/hexdek-freya/ --all-decks data/decks/benched/ --format markdown
//	go run ./cmd/hexdek-freya/ --deck my_deck.txt --format json
package main
...
func main() {
	...
	// Load oracle cards.
	log.Println("hexdek-freya starting")
